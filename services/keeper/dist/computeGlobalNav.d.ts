 ...
 */
export declare function computeGlobalNav(chains: ChainDeposits[], _hubPerpAllocated: bigint, hubPnL: bigint): PnLAdjustment[];
//# sourceMappingURL=computeGlobalNav.d.ts.map