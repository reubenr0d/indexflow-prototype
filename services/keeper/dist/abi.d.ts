...
export declare const StateRelayABI: readonly ["function updateState(uint64[] chains, uint256[] weights, address[] vaults, int256[] pnlAdjustments, uint48 ts)", "function lastUpdateTime() view returns (uint48)"];
