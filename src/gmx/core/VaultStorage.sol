...
abstract contract VaultStorage is ReentrancyGuard, IVault {
    ...
    function _increaseUsdgAmount(address _token, uint256 _amount) internal {
    ...
    function _decreaseUsdgAmount(address _token, uint256 _amount) internal {
