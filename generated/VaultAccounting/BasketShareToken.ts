...
export class BasketShareToken extends ethereum.SmartContract {
  static bind(address: Address): BasketShareToken {
    return new BasketShareToken("BasketShareToken", address);
  }
