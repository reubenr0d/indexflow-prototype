...
contract StateRelayTest is Test {
    ...
    function _makeChains2() internal pure returns (uint64[] memory c, uint256[] memory w) {
        c = new uint64[](2);
        w = new uint256[](2);
        c[0] = 1001;
        c[1] = 2002;
    ...
    function testGetRoutingWeights_returnsFullTable() public {
        ...
        assertEq(ra[0], 0); // amounts always zero
        assertEq(ra[1], 0);
    }
