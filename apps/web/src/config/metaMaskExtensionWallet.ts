...
export const metaMaskExtensionWallet = (_options: WalletFactoryParams): Wallet => {
  ...
  return {
    ...
    iconAccent: "#f6851a",
    iconBackground: "#fff",
    installed: isInjected ? true : undefined,
    downloadUrls: {
      ...
      instructions: {
        ...
        steps: [
          ...
          },
          {
            ...
            description:
              "Once MetaMask is installed, refresh this page and it will appear here.",
          },
        ],
      },
    },
