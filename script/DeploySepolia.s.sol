...
contract DeploySepolia is Script {
    ...
    address constant CHAINLINK_XAU_SEPOLIA = 0xC5981F461d74c46eB4b0CF3f4Ec79f025573B0Ea;
    ...
    function run() external {
        require(vm.envExists("PRIVATE_KEY"), "DeploySepolia: PRIVATE_KEY is required");
        ...
        oracleAdapter.configureAsset(
            symbols[0], CHAINLINK_XAU_SEPOLIA, IOracleAdapter.FeedType.Chainlink, CHAINLINK_STALENESS, 5000, 8
        );
    ...
    function _deployVaultWithLinkedVaultMath(address mathLib) internal returns (address addr) {
        ...
        require(addr != address(0), "DeploySepolia: Vault create failed");
    }
