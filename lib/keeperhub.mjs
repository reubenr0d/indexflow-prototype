...
// KeeperHub natively names a small set of chains and accepts numeric chain IDs
// for the rest (verified empirically: API error lists supported chains as
// ethereum/sepolia/base/base-sepolia/tempo/solana variants "or numeric chain
// IDs"). Anything not in the named list falls back to its decimal chain ID.
const NETWORK_MAP = {
  mainnet: "ethereum",
  ethereum: "ethereum",
  sepolia: "sepolia",
